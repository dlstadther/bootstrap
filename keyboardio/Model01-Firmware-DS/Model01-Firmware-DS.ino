...
#define PRIMARY_KEYMAP_DS


// #define FUNCTION_KEYMAP_DEFAULT
#define FUNCTION_KEYMAP_DS
...
#error "No default keymap defined. You should make sure that you have a line like '#define PRIMARY_KEYMAP_QWERTY' in your sketch"
...
#if defined (FUNCTION_KEYMAP_DEFAULT)
...
#elif defined (FUNCTION_KEYMAP_DS)
  /** Custom FN key combos
   *  T: Spectacle Corner
   *  G: Spectale Third
   *  B: Spectale Half/Full/Center
   *  TAB: spacebar
   *  ESC: Spectale Screen
   *  BTFLY: Alfred
   */
  ...
  (___,      Key_F1,           Key_F2,      Key_F3,     Key_F4,        Key_F5,           Key_CapsLock,
   ...
   Consumer_PlaySlashPause,    Consumer_ScanNextTrack, Key_LeftCurlyBracket,     Key_RightCurlyBracket,    Key_LeftBracket, Key_RightBracket, Key_F12,
                               Key_LeftArrow,          Key_DownArrow,            Key_UpArrow,              Key_RightArrow,  ___,              ___,
   M(MACRO_ALFRED),            Consumer_Mute,          Consumer_VolumeDecrement, Consumer_VolumeIncrement, ___,             Key_Backslash,    Key_Pipe,
   ___, ___, Key_Enter, ___,
   ___)

#else

#error "No default keymap defined. You should make sure that you have a line like '#define FUNCTION_KEYMAP_DEFAULT' in your sketch"
...
/** spotlightMacro is used to launch Mac's Spotlight search
 */
static void spotlightMacro(uint8_t keyState) {
  if (keyToggledOn(keyState)) {
...
/** alfredMacro is used to launch Mac's Alfred search
 */
static void alfredMacro(uint8_t keyState) {
  if (keyToggledOn(keyState)) {
